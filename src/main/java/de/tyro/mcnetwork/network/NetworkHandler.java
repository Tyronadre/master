...
import de.tyro.mcnetwork.network.payload.RegisterNetworkNodePayload;
...
public class NetworkHandler {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(
                RegisterNetworkNodePayload.TYPE,
                RegisterNetworkNodePayload.STREAM_CODEC,
                RegisterNetworkNodePayload::handle
        );
    }
